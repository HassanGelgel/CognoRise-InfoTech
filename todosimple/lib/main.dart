  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DefaultTabController(
        length: 2,
        child: Scaffold(
          backgroundColor: Color.fromRGBO(176, 201, 201, 1.0), // RGB color
          appBar: AppBar(
            // rgb(21, 83, 84)
            backgroundColor: Color.fromRGBO(21, 83, 84, 1.0), // RGB color
            title: Text(
              "SIMPLE TODO APP",
          ...
          bottomNavigationBar: Padding(
            ...
            child: Container(
              color:  Color.fromRGBO(21, 83, 84, 1.0), // RGB color
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: (todo[taskIndex][1] == false)
                    ? Color.fromRGBO(21, 83, 84, 1.0)
                    : Color.fromRGBO(84, 133, 134 ,1.0),
              ...
              child: Row(
                children: [
                  SizedBox(width: 5),
                  Container(
                    color: Color.fromRGBO(176, 201, 201, 1.0),
                    width: 16,
                    height: 16,
                    child: Checkbox(
